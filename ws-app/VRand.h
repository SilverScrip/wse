...
the difference in power becomes smaller, so the higher-pitched sounds are softer. 
Because the lower frequencies are louder than the higher frequencies in pink noise, 
it sounds less abrasive and leads to a better night's sleep.

Brown noise lowers the higher frequencies even more. It's a bit “rougher” than pink noise and 
resembles the roar of a river current or strong wind. Common benefits associated with brown noise 
are relaxation, improved focus, and of course, sleep improvement
*/
