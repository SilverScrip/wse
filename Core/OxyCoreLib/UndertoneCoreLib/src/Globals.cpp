...
namespace Globals
{
  ...
  int numTonesCompressionMultiTone = numTonesAll;//was 9, 10 for tones not closer than 2 intervals
  ...
  char frontDoorTokens[2] = {'1', 'j'}; //idx: 2, 24
  ...
  int init(int fftsize, float samplerate)
  {
    ...
    //nBinsOffsetForCustomMultiTone = 3; //should have been set using the function OXY_SetCustomOxysSeparation(...)
